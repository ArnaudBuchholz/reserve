...
* If, during the initialisation, the **current mappping** did not have a member named `configuration`, this member is set to the [configuration interface](handler.md#configuration-interface)
